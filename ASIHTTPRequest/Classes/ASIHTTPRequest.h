 ...
 */
typedef enum _ASIExpectedDataFormat{
    kASIExpectedDataBytes      = 1<<1,
    kASIExpectedDataString     = 1<<2,
    kASIExpectedDataDictionary = 1<<3
}ASIExpectedDataFormat;
...
typedef enum _ASIResponseDataFormat{
    ...
    kASIResponseDataXML     = 1<<5,
    kASIResponseDataJSON    = 1<<6
}ASIResponseDataFormat;
...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
    ...
    ASIExpectedDataFormat expectedDataFormat;
    ASIResponseDataFormat responseDataFormat;
}
...
@property (nonatomic,assign) ASIExpectedDataFormat expectedDataFormat;
@property (nonatomic,assign) ASIResponseDataFormat responseDataFormat;
